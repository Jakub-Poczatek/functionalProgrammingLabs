...
-- The names of all people in the survey, in alphabetical order
...
p5Lambda :: [(String, Category)]
p5Lambda = sortBy (\(n1, c1) (n2, c2) -> compare c1 c2) [(name p, category p) | p <- people]
